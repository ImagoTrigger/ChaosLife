...
_veh removeAction format ["%1",_id];
...
switch (true) do
{
	case (_height >= 20):
	{
		_obj_para = [_veh,_obj,"NonSteerable_Parachute_F"] spawn BTC_Paradrop;  
...
_obj addAction [" + """" + "<t color=""""#ED2744"""">" + "Drag " + (_name) + "</t>" + """" + ",""scripts\=BTC=_Logistic\=BTC=_Cargo_System\=BTC=_Drag.sqf"", """", 7, true, true];