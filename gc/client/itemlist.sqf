private ["_i","_item","_infos","_index","_benoetigteItems","_selected","_buttontext"];
if (!(createDialog "RscMenuItemInfo")) exitWith {hint "Dialog Error!";};
...
while {ctrlVisible 1038} do {
  ...
  ctrlSetText [3,  format ["Weight: %1", (_infos call INV_getitemTypeKg)]];
