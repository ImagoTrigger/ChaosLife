...
private ["_mode","_params","_display"];
...
switch _mode do {
	case "onLoad": {
		_params spawn {
			...
			//--- Refresh
			waituntil {
				_current = missionnamespace getvariable "GC_Timer_current";
				...
				_bonus = missionnamespace getvariable "GC_Timer_bonus";
				...
				_penalty = missionnamespace getvariable "GC_Timer_penalty";
				...
				_best = missionnamespace getvariable "GC_Timer_best";
				if !(isnil {_best}) then {
				...
				_previous = missionnamespace getvariable "GC_Timer_previous";
				...
				sleep 0.01;
				(missionnamespace getvariable ["GC_Timer_done",false])
			};
