...
// Custom Styles
#define MEDIUM_TEXT "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 33) * 1)"
#define BIGGER_TEXT "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 30) * 1)"
