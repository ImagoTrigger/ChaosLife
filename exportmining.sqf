...
if(_stock >= _maxstock)exitwith{player groupchat "The shop has reached its maximum stock for this tool.";fvspam=false;};

['cash', _preis] call INV_AddInventoreItem;

player groupchat format["The tool has been exported for $%1!", _preis];
